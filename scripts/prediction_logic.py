#!/usr/bin/env python3
"""Single source of truth for Predictjra prediction rules.

This module intentionally contains only deterministic, source-agnostic prediction logic.
Both live prediction (predict_engine.py) and historical rebuild/backtest
(rebuild_history.py) normalize their source data and call these same functions.

A future rule change should be implemented here first. Source adapters may change only
when the shape/source of the input data changes.
"""
