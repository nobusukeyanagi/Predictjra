    ...
    <div class="index-modal-backdrop" data-index-close="true">
      <section class="index-modal" role="dialog" aria-modal="true" aria-labelledby="index-modal-title">
        ...
        <div class="index-logic">
          ...
          <p><strong>軸馬選定：</strong>まず想定1〜3番人気のうち総合評価が最も低い1頭を危険馬として選定対象から除外します。そのうえで、出走頭数に応じた既定の選定対象馬数（出走頭数の半数切り上げ、最大7頭）を総合評価上位から選びます。本命は選定対象馬のうち総合評価1位、対抗は選定対象馬のうち想定人気が最も低い馬とし、残りを相手とします。</p>
        </div>
      </section>
    </div>`;
}
